...
function filltablewithjerseys(array_participantteamplayers, array_participantteamcountry){
    ...
    for(i = 0; i < array_jersey_positions.length; i++){
        ...
        img_jersey.src = "../Team_Shirts/" + array_participantteamcountry[i] + ".png";

        //This function does run but not at the proper time thats why not shown on screen
        img_jersey.onerror = function(){
            console.log("OK");
            img_jersey.src = "../Team_Shirts/Plain_Shirt.png";
        }
