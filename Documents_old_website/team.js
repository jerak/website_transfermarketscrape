		...
		$.ajax({
            ...
            success: function(data){
            	$.each(data.playerslist, function(key, value){
            			...
            			var img_player = "../Player_Images/" + data.playerscountry[key] + " " + data.playerslist[key] + ".jpg";
            			array_player_images.push(img_player);

            			var img_club = "../Club_Logos/" + data.playersclub[key] + ".png";
            			array_player_club_img.push(img_club);
            			array_player_club_name.push(data.playersclub[key]);

            			var img_country = "../Country_Images/" + data.playerscountry[key] + ".png";
